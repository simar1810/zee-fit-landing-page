...
export function MissionSection() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        >
          {pillars.map((pillar, index) => (
            ...
            >
              <Card className="relative overflow-hidden p-10 bg-white/5 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-500 h-full ">
  ...
  transition={{ duration: 1.5 }}
  viewport={{ once: true, amount: 0.3 }}
  className="text-center mb-12 px-4 sm:mb-20"
>
  <div className="relative mx-auto mb-8" style={{ width: '90vw', maxWidth: 320, aspectRatio: '1 / 1' }}>
    {/* Globe Base */}
    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-green-500/20 to-orange-500/20 border border-white/10">
      ...
      {[...Array(8)].map((_, i) => {
        ...
        const radius = 40; // smaller radius relative to container
        const center = 50; // percentage center
        ...
        return (
          <motion.div
            ...
            className="absolute w-3 h-3 sm:w-2 sm:h-2 bg-gradient-to-r from-green-400 to-orange-400 rounded-full shadow-lg"
          />
        );
      })}
    </div>
  ...
  <motion.p
  className="text-xl sm:text-sm text-gray-300 "
...
>
  From one college
  one office, one city — to the world.
</motion.p>
        ...
        >
          <h2 className="text-4xl md:text-5xl mb-8 mt-10 text-white">
